...
function calculateInclination(vector: { x: number; y: number; z: number }): number {
...
function rotateVector(vector: { x: number; y: number; z: number }, azimuth: number, inclination: number): { x: number; y: number; z: number } {
...
function latLngToCartesian(longitude: number, latitude: number, radius: number) {
...
const DirectionalVector = ({ long, lat, az }: LineProps) => {
